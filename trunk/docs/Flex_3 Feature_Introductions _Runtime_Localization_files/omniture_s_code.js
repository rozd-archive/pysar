...
var s_linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,doc,pdf,xls,hqx,dmg,mxp,bin,jar,adpp,air"
var s_linkInternalFilters="javascript:,macromedia,dreamweaver,flash,shockwave,sdc,markme,sdc.shockwave,infopoll,developerlocator.macromedia,adobe.com"
...
function s_doPlugins() {
	...
	s_vp_getCGI('s_prop19','product');
	s_vp_getCGI('s_prop20','topic');
	if(s_vp_getValue('s_prop19')) {
		// ADC Tutorial Search
		s_vp_getCGI('s_prop6','term');
		s_vpr('s_prop6', s_vp_getValue('s_prop6').toLowerCase());
	}
	else {
		// Standard Adobe Site Search
		s_vp_getCGI('s_prop2','term');
		s_vpr('s_prop2', s_vp_getValue('s_prop2').toLowerCase());
		s_vp_getCGI('s_eVar21','term');
		s_vpr('s_eVar21', s_vp_getValue('s_eVar21').toLowerCase());
	}
	if(s_vp_getValue('s_prop2')) 
		s_events=s_events?s_events+',event18':'event18';
	s_vp_getCGI('s_campaign','trackingid');
	s_vpr('s_campaign',s_getValOnce(s_vp_getValue('s_campaign'),'s_campaign',0));
	s_vp_getCGI('s_eVar2','promoid');
	s_vpr('s_eVar2',s_getValOnce(s_vp_getValue('s_eVar2'),'eVar2',0));
	s_vp_getCGI('s_eVar9','sdid');
	s_vpr('s_eVar9',s_getValOnce(s_vp_getValue('s_eVar9'),'eVar9',0));
	s_vp_getCGI('s_eVar11','pss');
	s_vp_getCGI('s_eVar17','prid');
	s_vp_getCGI('s_prop1','area');
	s_vp_getCGI('s_prop26','xNav');
}
 ...
 */
function s_getValOnce(v,c,e){
      var k=s_c_r(c),a=new Date;e=e?e:0;
      if(v){
