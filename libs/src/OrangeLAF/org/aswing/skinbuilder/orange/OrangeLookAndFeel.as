...
public class OrangeLookAndFeel extends BasicLookAndFeel{
	...
	public function OrangeLookAndFeel(){
		super();
	}
	...
	//vertical
	[Embed(source="assets/ScrollBar_thumbVertical_defaultImage.png", scaleGridTop="4", scaleGridBottom="26", 
		scaleGridLeft="6", scaleGridRight="10")]
	private var ScrollBar_thumbVertical_defaultImage:Class;
	
	[Embed(source="assets/ScrollBar_thumbVertical_pressedImage.png", scaleGridTop="4", scaleGridBottom="26", 
		scaleGridLeft="6", scaleGridRight="10")]
	private var ScrollBar_thumbVertical_pressedImage:Class;
	
	[Embed(source="assets/ScrollBar_thumbVertical_rolloverImage.png", scaleGridTop="4", scaleGridBottom="26", 
		scaleGridLeft="6", scaleGridRight="10")]
	private var ScrollBar_thumbVertical_rolloverImage:Class;
	
	[Embed(source="assets/ScrollBar_thumbVertical_disabledImage.png", scaleGridTop="4", scaleGridBottom="26", 
		scaleGridLeft="6", scaleGridRight="10")]
	...
	[Embed(source="assets/ScrollBar_thumbHorizontal_defaultImage.png", scaleGridTop="6", scaleGridBottom="10", 
		scaleGridLeft="4", scaleGridRight="26")]
	...
	//=====================================================================
	[Embed(source="assets/TextField_defaultImage.png", scaleGridTop="4", scaleGridBottom="17", 
		scaleGridLeft="4", scaleGridRight="138")]
	private var TextField_defaultImage:Class;
	
	[Embed(source="assets/TextField_uneditableImage.png", scaleGridTop="4", scaleGridBottom="17", 
		scaleGridLeft="4", scaleGridRight="138")]
	private var TextField_uneditableImage:Class;
	
	[Embed(source="assets/TextField_disabledImage.png", scaleGridTop="4", scaleGridBottom="17", 
		scaleGridLeft="4", scaleGridRight="138")]
	...
	//========================================================================
	[Embed(source="assets/TextArea_defaultImage.png", scaleGridTop="4", scaleGridBottom="17", 
		scaleGridLeft="4", scaleGridRight="138")]
	private var TextArea_defaultImage:Class;
	
	[Embed(source="assets/TextArea_uneditableImage.png", scaleGridTop="4", scaleGridBottom="17", 
		scaleGridLeft="4", scaleGridRight="138")]
	private var TextArea_uneditableImage:Class;
	
	[Embed(source="assets/TextArea_disabledImage.png", scaleGridTop="4", scaleGridBottom="17", 
		scaleGridLeft="4", scaleGridRight="138")]
	...
	[Embed(source="assets/Frame_activeBG.png", scaleGridTop="27", scaleGridBottom="212", 
		scaleGridLeft="12", scaleGridRight="354")]
	private var Frame_activeBG:Class;
	
	[Embed(source="assets/Frame_inactiveBG.png", scaleGridTop="27", scaleGridBottom="212", 
		scaleGridLeft="12", scaleGridRight="354")]
	...
	override protected function initComponentDefaults(table:UIDefaults):void{
		...
		comDefaults = [
			...
			"ScrollBar.thumbVertical.iconPressedImage", ScrollBar_thumbVertical_iconPressedImage, 
			"ScrollBar.thumbVertical.iconDisabledImage", ScrollBar_thumbVertical_iconDisabledImage, 
			"ScrollBar.thumbVertical.iconRolloverImage", ScrollBar_thumbVertical_iconRolloverImage, 
			...
			"ScrollBar.thumbHorizontal.iconPressedImage", ScrollBar_thumbHorizontal_iconPressedImage, 
			"ScrollBar.thumbHorizontal.iconDisabledImage", ScrollBar_thumbHorizontal_iconDisabledImage, 
			"ScrollBar.thumbHorizontal.iconRolloverImage", ScrollBar_thumbHorizontal_iconRolloverImage, 
		...
		comDefaults = [
			...
			"TabbedPane.contentMargin", new InsetsUIResource(3, 3, 3, 3), //modify this to fit TabbedPane_contentRoundImage
